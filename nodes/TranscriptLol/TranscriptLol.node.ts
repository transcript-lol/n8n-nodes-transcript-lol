        ...
        options: [
          {
            ...
            default: "",
            description:
              "Optional unique ID from your own system to identify this recording. Used to prevent duplicate recordings.",
          },
          {
          ...
          if (operation === "create") {
            ...
            if (additionalFields.externalMetadata?.metadataValues) {
              body.externalMetadata =
                additionalFields.externalMetadata.metadataValues;
            }
            ...
            const recordingId = this.getNodeParameter(
              "recordingId",
              i
            ) as string;
