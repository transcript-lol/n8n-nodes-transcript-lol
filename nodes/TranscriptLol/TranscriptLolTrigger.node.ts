        ...
        options: [
          {
            ...
            description:
              "Triggers when a transcript is completed for a recording",
          },
          {
          ...
          },
          {
            ...
            description:
              "Triggers when new AI insights are generated for a recording",
          },
          {
            name: "Translation Created",
            value: "TRANSLATION_CREATED",
            description:
              "Triggers when a translation is completed for a recording",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            default: true,
            description:
              "Whether to fetch and include the full transcript content",
          },
        ],
      },
    ],
  ...
  methods = {
    loadOptions: {
      async getWorkspaces(
        ...
        return (workspaces as Array<{ id: string; name: string }>).map(
          (workspace) => ({
            name: workspace.name,
            value: workspace.id,
          })
